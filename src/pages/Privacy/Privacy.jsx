...
export default function Privacy(){
  ...
  return (
      ...
      >
        ...
        tramite terzi nel passato, come quelli che saranno raccolti nel futuro, potranno formare oggetto di trattamento
        nel pieno rispetto del Regolamento UE. Il Titolare del trattamento effettua il trattamento in maniera lecita
        nello specifico per l’esecuzione di un contratto di cui Lei è parte o per l’esecuzione di misure precontrattuali
        (es. preparazione di un’offerta, ecc.) da Lei richieste (art. n. 6 del Regolamento UE). Per trattamento dei dati
        ...
        saranno conservati nel rispetto del principio di proporzionalità e comunque fino a che non siano state
        perseguite le finalità del trattamento o fino a che non intervenga la revoca del consenso specifico da parte
